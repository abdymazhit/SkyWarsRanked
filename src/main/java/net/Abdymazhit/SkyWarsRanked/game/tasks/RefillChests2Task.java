...
/**
 * Представляет собой второе игровое событие перезаполнения сундуков
 *
 * @version   21.08.2021
 * @author    Islam Abdymazhit
 */
public class RefillChests2Task extends BukkitRunnable {
     ...
     */
    public RefillChests2Task(GameEventsManager gameEventsManager) {
    ...
    public void run() {
        ...
        if (timeLeft-- <= 0) {
            ...
            gameEventsManager.task = new DeathmatchStartTask(gameEventsManager);
